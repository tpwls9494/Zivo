...
export default function App() {
  ...
  return (
    <div className="p-4 space-y-3 text-sm min-w-[320px]">
      ...
      <div className="flex border-b text-xs">
        <button
          className={`px-3 py-2 ${tab === "search" ? "border-b-2 border-black font-semibold" : "text-gray-500"}`}
          onClick={() => setTab("search")}
        >
          검색
        </button>
        <button
          className={`px-3 py-2 ${tab === "profile" ? "border-b-2 border-black font-semibold" : "text-gray-500"}`}
